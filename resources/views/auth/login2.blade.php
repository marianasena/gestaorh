        ...
        <div class="row">
            ...
            <div class=" col-md-9">
                ...
                <div class="login-form">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback {{ $errors->has('usuario') ? ' has-error' : '' }}">
                                <input type="text" class="form-control" name="username" id="username" placeholder="Usuário" aria-describedby="basic-addon1" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback {{ $errors->has('paassword') ? ' has-error' : '' }}">
                                <input type="text" class="form-control" name="paassword" id="paassword" placeholder="Senha" aria-describedby="basic-addon1" />
